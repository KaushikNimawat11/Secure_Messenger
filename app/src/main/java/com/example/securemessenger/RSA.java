...
public class RSA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //  Log.d("KAUSHIK", "encrypt key:" +encrypted);
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //    Log.d("KAUSHIK", "encrypt key:" +decrypted);
    ...
    public static String encryptRSAToString(String clearText, String publicKey) {
        ...
        return encryptedBase64.replaceAll("(\\r|\\n)", "");//new line or carriage return replace and send
    }
    ...
    public void getspeechinput(View view) {
        ...
        {
            Toast.makeText(this,"your device do not support this feature", Toast.LENGTH_SHORT).show();
        }
    }
